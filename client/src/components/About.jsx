    ...
    <div className='flex flex-col m-2 md:m-10 border border-gray-100 shadow-xl rounded-2xl'>
      <div className='m-4 md:m-10'>
        <h1 className='text-lg md:text-4xl'>
          Подробнее о компании <span className='font-bold text-blue-950'>PawCare</span>
        </h1>

        <div className='flex flex-col gap-6 mt-5'>
          <p className='text-gray-700 leading-relaxed text-base'>PawCare — современная ветеринарная клиника, которая объединяет опытных специалистов и передовые технологии. Мы работаем с 2012 года и за это время помогли более чем 10 000 домашних животных.</p>
